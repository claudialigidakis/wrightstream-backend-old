  ...
  return knex('purchases_bundles').del()
    .then(function () {
      return knex('purchases_bundles').insert([
        ...
        {purchase_id: 8, bundle_id: 1, bundle_qty: 1, completed: true},
        {purchase_id: 8, bundle_id: 2, bundle_qty: 2, completed: false},
        {purchase_id: 8, bundle_id: 3, bundle_qty: 1, completed: false},

        {purchase_id: 9, bundle_id: 3, bundle_qty: 1, completed: true},
        {purchase_id: 9, bundle_id: 2, bundle_qty: 5, completed: true},
        {purchase_id: 9, bundle_id: 1, bundle_qty: 1, completed: true},
        ...
        {purchase_id: 14, bundle_id: 3, bundle_qty: 12, completed: true},
        {purchase_id: 14, bundle_id: 2, bundle_qty: 2, completed: true},

        {purchase_id: 15, bundle_id: 1, bundle_qty: 15, completed: true},

        {purchase_id: 16, bundle_id: 2, bundle_qty: 20, completed: false},

        {purchase_id: 17, bundle_id: 1, bundle_qty: 6, completed: true},
        {purchase_id: 17, bundle_id: 3, bundle_qty: 2, completed: true},

        {purchase_id: 18, bundle_id: 1, bundle_qty: 7, completed: true},
        {purchase_id: 18, bundle_id: 2, bundle_qty: 2, completed: true},

        {purchase_id: 20, bundle_id: 3, bundle_qty: 8, completed: true},
        {purchase_id: 20, bundle_id: 2, bundle_qty: 2, completed: true},
      ])
    })
};
