  ...
  return knex('supplies').del()
    .then(function () {
      ...
      return knex('supplies').insert([
        {id: 1, name: 'Milk', stock_qty: 60, stock_qty_measure_type: 'volume', shop_id: 1, source_id: 1, kind_id: 1},
        {id: 2, name: 'Flour', stock_qty: 60, stock_qty_measure_type: 'volume', shop_id: 1, source_id: 3, kind_id: 4},
        {id: 3, name: 'Frosting', stock_qty: 20, stock_qty_measure_type: 'volume', shop_id: 1, source_id: 2, kind_id: 2},
