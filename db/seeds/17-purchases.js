  ...
  return knex('purchases').del()
    .then(function () {
      return knex('purchases').insert([
        ...
        {id: 7, shop_id: 1, staff_id: 3, purchase_date: '5/6/18'},
