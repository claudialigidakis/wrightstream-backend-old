...
function updateItems(req, res, next) {
  ...
  itemsModel.updateItems(parseInt(req.params.itemId), req.body.name, req.body.deleted, req.body.stock, req.body.steps, req.body.category, req.body.product, req.body.supplies)
  .then(data => {
    res.status(200).send({ data })
  })
  .catch(next)
